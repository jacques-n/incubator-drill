...
public class MongoStoragePlugin extends AbstractStoragePlugin {
  ...
  public MongoClient getClient(String host) throws UnknownHostException {
  ...
  public synchronized MongoClient getClient(List<ServerAddress> addresses) throws UnknownHostException {
