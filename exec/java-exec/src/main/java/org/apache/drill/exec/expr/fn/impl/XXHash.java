...
public final class XXHash {
  ...
  static final long PRIME64_2 = UnsignedLongs.decode("14029467366897019727l");
  ...
  public static long hash64(long start, long bEnd, long seed) {
    ...
    if (len >= 32) {
      ...
      do {
        v1 += PlatformDependent.getLong(p += 8) * PRIME64_2;
        v1 = Long.rotateLeft(v1, 31);
        v1 *= PRIME64_1;

        v2 += PlatformDependent.getLong(p += 8) * PRIME64_2;
        v2 = Long.rotateLeft(v2, 31);
        v2 *= PRIME64_1;

        v3 += PlatformDependent.getLong(p += 8) * PRIME64_2;
        v3 = Long.rotateLeft(v3, 31);
        v3 *= PRIME64_1;

        v4 += PlatformDependent.getLong(p += 8) * PRIME64_2;
