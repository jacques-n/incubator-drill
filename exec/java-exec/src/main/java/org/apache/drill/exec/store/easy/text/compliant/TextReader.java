...
public final class TextReader {
  ...
  private final RepeatedVarCharOutput output;
...
//  private final byte newLine;
   ...
   */
  public TextReader(TextParsingSettings settings, TextInput input, RepeatedVarCharOutput output, DrillBuf workBuf) {
...
//    this.comment = settings.getComment();
  ...
  public RepeatedVarCharOutput getOutput(){
    return output;
  }
