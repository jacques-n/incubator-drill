...
public abstract class AbstractStatusReporter implements StatusReporter{
  ...
  public static FragmentStatus.Builder getBuilder(final FragmentContext context, final FragmentState state, final String message, final Throwable t){
  ...
  @Override
  public final void fail(final FragmentHandle handle, final Throwable excep) {
    final FragmentStatus.Builder status = getBuilder(context, FragmentState.FAILED, "Fragment Failed", excep);
    fail(handle, status);
  }
