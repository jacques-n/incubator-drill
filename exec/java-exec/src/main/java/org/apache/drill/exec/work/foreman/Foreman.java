...
public class Foreman implements Runnable, Closeable, Comparable<Object> {
  ...
  private void parseAndRunLogicalPlan(String json) throws ForemanException {
  ...
  private void returnPhysical(PhysicalPlan plan) throws OutOfMemoryException, ForemanException {
  ...
  private void parseAndRunPhysicalPlan(String json) throws OutOfMemoryException, ForemanException {
    try {
  ...
  private void runPhysicalPlan(PhysicalPlan plan) throws OutOfMemoryException, ForemanException {
  ...
  private QueryWorkUnit getQueryWorkUnit(PhysicalPlan plan) throws ForemanException {
...
//            .build();
  ...
  private void runSQL(String sql) throws OutOfMemoryException, ForemanException {
  ...
  private void setupRootFragment(PlanFragment rootFragment, UserClientConnection rootClient, FragmentRoot rootOperator) throws OutOfMemoryException, ForemanException{
