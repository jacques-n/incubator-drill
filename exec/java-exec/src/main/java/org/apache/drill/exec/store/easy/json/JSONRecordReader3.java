...
import org.apache.drill.exec.vector.complex.fn.JsonReader2;
...
public class JSONRecordReader3 extends AbstractRecordReader {
  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(JSONRecordReader3.class);
  ...
  private JsonReader2 jsonReader;
  ...
  public JSONRecordReader3(FragmentContext fragmentContext, String inputPath, FileSystem fileSystem,
  ...
  public void setup(OutputMutator output) throws ExecutionSetupException {
    try{
      ...
      this.mutator = output;
      this.jsonReader = new JsonReader2(fragmentContext.getManagedBuffer(), columns, enableAllTextMode);
