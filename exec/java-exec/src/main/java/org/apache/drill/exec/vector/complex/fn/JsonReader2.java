...
public class JsonReader2 {
  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(JsonReader2.class);
  ...
  public JsonReader2() throws IOException {
    this(null, false);
  }

  public JsonReader2(DrillBuf managedBuf, boolean allTextMode) throws IOException {
    this(managedBuf, GroupScan.ALL_COLUMNS, allTextMode);
  }

  public JsonReader2(DrillBuf managedBuf, List<SchemaPath> columns, boolean allTextMode) throws JsonParseException, IOException {
  ...
  public <T extends InputStream & Seekable> void setSource(byte[] bytes) throws IOException{
