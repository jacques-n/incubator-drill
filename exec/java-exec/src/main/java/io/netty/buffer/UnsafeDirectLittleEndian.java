...
public final class UnsafeDirectLittleEndian extends WrappedByteBuf {
  ...
  private final static IdentityHashMap<UnsafeDirectLittleEndian, StackTrace> bufferMap =
      TRACK_BUFFERS ? new IdentityHashMap<UnsafeDirectLittleEndian, StackTrace>()
      : null;
